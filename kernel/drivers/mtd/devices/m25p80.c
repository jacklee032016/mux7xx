...
static int m25p_probe(struct spi_device *spi)
{
	...
	dev_dbg(&spi->dev, "probe exit 4 byte mode.dev_dbg\n");
	dev_err(&spi->dev, "probe exit 4 byte mode.dev_err\n");
	dev_dbg(&spi->dev, "probe reset qspi flash.dev_dbg\n");
	dev_err(&spi->dev, "probe reset qspi flash.dev_err\n");
...
static int m25p_remove(struct spi_device *spi)
{
	...
	dev_dbg(&spi->dev, "exit 4 byte mode.dev_dbg\n");
	dev_err(&spi->dev, "exit 4 byte mode.dev_err\n");

	flash->command[0] = 0x66; 
	spi_write(flash->spi, flash->command, 1);
	flash->command[0] = 0x99; 
	spi_write(flash->spi, flash->command, 1);  
	dev_dbg(&spi->dev, "reset qspi flash.dev_dbg\n");
	dev_err(&spi->dev, "reset qspi flash.dev_err\n");
...
static void m25p80_soft_reset(struct spi_device *spi) 
{ 
	/*
	struct m25p *flash = spi_get_drvdata(spi); 
	flash->command[0] = 0xE9; 
