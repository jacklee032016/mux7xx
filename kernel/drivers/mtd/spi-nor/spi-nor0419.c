...
#define USE_SHUTDOWN_RESET 	BIT(13) /* Muxlab, need exit 4 byte mode on shutdown*/ 
};
			    ...
			    int enable)
{
	...
	dev_info(dev, "Muxlab. call set_4byte function, this is wrong!!!.\n");
...
static const struct flash_info spi_nor_ids[] = {
	...
	//{ "n25q256a",    INFO(0x20ba19, 0, 64 * 1024,  512, SECT_4K | SPI_NOR_QUAD_READ | USE_SHUTDOWN_RESET) },
	//{ "n25q256a",    INFO(0x20ba19, 0, 64 * 1024,  512, SECT_4K | USE_SHUTDOWN_RESET) },  
	{ "n25q256a",    INFO(0x20ba19, 0, 64 * 1024,  256, SECT_4K | USE_SHUTDOWN_RESET) }, //muxlab. test for only 16MB, NO 4 byte mode and QSPI QUAD
		 ...
		 const struct spi_nor_hwcaps *hwcaps)
{
	...
	if (info->flags & USE_SHUTDOWN_RESET)
    {
		...
		dev_info(dev, "Muxlab add spi_nor_shutdown callback.\n");
	}
...
static const struct flash_info *spi_nor_match_id(const char *name)	//muxlab
{
